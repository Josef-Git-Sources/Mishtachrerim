...
* the page loads the result using the result id
* results are viewable without login
* saving results to a user profile requires login
...
/career?id=123
/page-1
/article/army_post_release_guide_v2
