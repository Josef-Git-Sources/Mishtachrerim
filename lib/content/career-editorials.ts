...
const CAREER_EDITORIALS: Record<string, CareerEditorial> = {
  ...
  'data-analyst-vs-full-stack-developer': {
    slug: 'data-analyst-vs-full-stack-developer',
    title: 'Data Analyst או Full Stack Developer — מה ההבדל ומה מתאים לך?',
    description:
      'השוואה בין Data Analyst ל-Full Stack Developer: אופי העבודה, עומק טכני, הכשרה ומה עשוי להתאים לך יותר.',
    h1: 'Data Analyst או Full Stack Developer — מה ההבדל ומה מתאים לך?',
    intro:
      'שני המקצועות האלה נמצאים בצד הטכני של שוק העבודה, אבל עונים על שאלות מהותית שונות. ' +
      'Full Stack Developer בונה מוצרים דיגיטליים. Data Analyst מנתח את הנתונים שהמוצרים האלה מייצרים. ' +
      'מי שמתלבט בין השניים כדאי שיבין מה סוג הבעיות שהוא רוצה לפתור ביום-יום — לפני שמתחייב להכשרה.',
    sections: [
      {
        heading: 'מה עושה Full Stack Developer ביום-יום',
        paragraphs: [
          'Full Stack Developer כותב קוד שבונה מוצרים — דפים, תכונות, תהליכים. ' +
            'העבודה מחולקת בין צד לקוח (מה שהמשתמש רואה) לצד שרת (הלוגיקה והנתונים שמאחורי הקלעים). ' +
            'רוב היום עובר על כתיבה, בדיקה ותיקון של קוד.',
          'המסגרות הנפוצות בישראל הן React בצד הלקוח ו-Node.js בצד השרת, לרוב עם JavaScript או TypeScript. ' +
            'עבודה בצוות היא חלק משמעותי — code reviews, תיאום עם עיצוב ו-QA, ותקשורת שוטפת על דרישות.',
        ],
      },
      {
        heading: 'מה עושה Data Analyst ביום-יום',
        paragraphs: [
          'Data Analyst עונה על שאלות עסקיות באמצעות נתונים. ' +
            'זה יכול להיות מעקב אחר מדדי ביצועים, ניתוח התנהגות משתמשים, או בניית דוחות לצוותים שצריכים ' +
            'לקבל החלטות מבוססות-מידע.',
          'כלי הליבה הם SQL, Excel או Google Sheets לניתוח ראשוני, וכלי ויזואליזציה כמו Tableau או Power BI. ' +
            'בחברות גדולות יותר יש שימוש ב-Python לניתוחים מורכבים. ' +
            'הרבה מהעבודה היא עבודה עצמאית — שאילת שאלות, ניתוחן, והצגת תוצאות.',
        ],
      },
      {
        heading: 'עומק טכני — אופי העיסוק בטכנולוגיה',
        paragraphs: [
          'Full Stack Development הוא מקצוע שבמרכזו בנייה. התוצר הוא תוכנה עובדת — פיצ\'ר, דף, שירות. ' +
            'התכנות הוא לא אמצעי אלא עיקר: בלי כתיבת קוד יומיומית אין עבודה.',
          'Data Analysis הוא מקצוע שבמרכזו חקירה. התוצר הוא תובנה — מספר, גרף, מסקנה. ' +
            'SQL ו-Python הם כלים לשאלות, לא מטרה בפני עצמה. ' +
            'מי שנמשך לשאלת "למה?" ולחיפוש דפוסים בתוך נתונים יתחבר יותר לאנליזה. ' +
            'מי שנמשך לשאלת "איך בונים את זה?" יתחבר יותר לפיתוח.',
        ],
      },
      {
        heading: 'הכשרה וציפיות בכניסה לשוק',
        paragraphs: [
          'הכשרת Full Stack Development נמשכת בדרך כלל שישה עד תשעה חודשים, ואחריה נדרש פרויקט גמר ' +
            'משמעותי ופורטפוליו לפני שמחפשים עבודה. הכניסה לתפקיד ראשון תחרותית ודורשת הוכחת יכולת מעשית.',
          'הכשרת Data Analyst דומה באורכה לגרסה המעשית — כארבעה חודשים — אך כוללת מרכיב של מתמטיקה ' +
            'וסטטיסטיקה שדורשים תרגול עצמאי בנוסף לשיעורים. ' +
            'גם כאן נדרש פורטפוליו של פרויקטים אמיתיים לפני הכניסה לשוק.',
        ],
      },
      {
        heading: 'מה עשוי להתאים לך יותר',
        paragraphs: [
          'אם אתה רוצה לבנות דברים — לכתוב קוד שיוצר מוצר שאחרים משתמשים בו — ' +
            'Full Stack Development הוא הכיוון הישיר יותר.',
          'אם אתה רוצה להבין דברים — לחפור בנתונים, לאתר דפוסים, ולענות על שאלות עסקיות — ' +
            'Data Analysis הוא הכיוון הטבעי יותר.',
          'שני המסלולים דורשים סבלנות, דיוק, ויכולת לעבוד עם פרטים קטנים. ' +
            'ההבדל העיקרי הוא בשאלה מה מעניין אותך יותר: לבנות את המוצר, או להבין מה הוא עושה.',
        ],
      },
    ],
    careers: [
