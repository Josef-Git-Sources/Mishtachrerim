...
const GUIDES: Record<string, Guide> = {
  'what-to-do-after-army': {
    ...
    intro:
      'רוב המשוחררים עוזבים את הצבא בלי תוכנית מקצועית מסודרת — וזה נורמלי לגמרי. השאלה החשובה היא לא "מה עושים מחר", אלא לאיזה כיוון מקצועי כדאי להתחיל לנוע. המדריך הזה מסביר אילו אפשרויות עומדות בפניכם ואיך לבחור מקצוע שיתאים לכם.',
    sections: [
      {
  ...
  'how-to-enter-high-tech-without-degree': {
    ...
    sections: [
      {
        heading: 'האם באמת אפשר להיכנס להייטק בלי תואר?',
        paragraphs: [
          'כן — ובכמה מקצועות הייטק, תואר אפילו לא נחשב ליתרון משמעותי. בתחומים כמו QA, עיצוב UX/UI ושיווק דיגיטלי, מעסיקים מסתכלים על תיק עבודות, פרויקטים שעשיתם, ויכולות שהדגמתם בפועל.',
          'גם בניתוח נתונים — שנחשב בעבר לדרוש תואר — בוטקמפים איכותיים של 6 חודשים מוכרים יותר ויותר. הסיבה פשוטה: מחסור כרוני בכוח אדם מקצועי בכל רחבי התעשייה.',
        ],
      },
      {
